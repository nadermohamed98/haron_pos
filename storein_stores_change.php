...
$sql="INSERT INTO ".$prefix."_stores_change_temporary (inv_id, item, Price, Quantity, color, size, Discount, Total, SupplierID, BuyPrice, date, type, subqty, stores_change_type)
