...
<!--<div style="background-color:#C9C9C9; width:200px; float:right; border:0px;">
  ...
  <ul style="direction:rtl; width:100%; margin-top:0px; float:right;list-style: none;">
...
while($row_search_clients = mysqli_fetch_array($result_search_clients))
  {
    ...
    echo'<li class="'.$class.'"><a href="?reports=items_returns&q='.$row_search_clients['id'].'">'.$row_search_clients['item'].' </a></li>';
  $i++;
   }
}else{
