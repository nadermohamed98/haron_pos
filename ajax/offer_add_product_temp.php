...
if (isset($_POST['ch_status']) and $_POST['ch_status']=='chngeQ') {
    ...
    while ($row_up = mysqli_fetch_array($result_up)) {
        ...
        $offers_type = $_POST[offers_type . $row_up['id']];
        ...
        if ($quantity != 0 or $quantity != "") {
            $productQuanSql = "UPDATE " . $prefix . "_offers_temporary SET Quantity='" . $quantity  . "',user_id='$user_id'  where id='" . $row_up['id'] . "'";
...
if ($_GET['del'] !== null) {
    if (mysqli_query($con, "DELETE FROM " . $prefix . "_offers_temporary where user_id='$user_id' and id=" . $_GET['del'] . "")) {
...
//        else{
            ...
            if (@mysqli_num_rows($result_new) >= 1) {
                ...
                while ($row_new = mysqli_fetch_array($result_new)) {
                    ...
                    $sql = "INSERT INTO " . $prefix . "_offers_temporary (name,item, Quantity,  date, user_id)
