                    ...
                    <table border="0" dir="rtl" cellpadding="0"
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <div class="col-12">
                                    <input type="text" name="name" value="<?php echo "" . $row_region_name . ""; ?>"
                                           class="form-control"/>
                            ...
                            <th colspan="6" class="text-center">
                                <div>
                                    ...
                                    <input type="button" class="button" value="<?php echo "$Cancel_lang"; ?>"
                                           onclick="javascript:location.href='centers.php'"/>
                                </div>
                            </th>
                        </tr>
                        <tr class="text-right">
                    ...
                    <th class="text-center <?php if ($_GET['type'] == "ASC" and $_GET['orderby'] == "parent_id") {
                        ...
                        echo "sort0";
                            ...
                            echo "DESC";
                             ...
                             class="a_remove_underlines"><?php echo "$parent_id_lang"; ?></a></th>
