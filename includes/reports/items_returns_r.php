...
$to=stripslashes(date('Y-m-d',strtotime($to)));
	...
	*/
	$query = "SELECT COUNT(*) as num  FROM  ".$prefix."_sales where item=".$_GET['q']." and type='2' and  left(date, 10) BETWEEN '$from' AND '$to'";
...
$sql = "SELECT * FROM ".$prefix."_sales where item=".$_GET['q']." and type='2' and left(date,10) BETWEEN '$from' AND '$to' order by date DESC LIMIT $start, $limit";	
...
$result_get = mysqli_query($con,"SELECT Total FROM ".$prefix."_sales where item=".$_GET['q']." and type='2' and left(date,10) BETWEEN '".$from."' AND '".$to."'");
