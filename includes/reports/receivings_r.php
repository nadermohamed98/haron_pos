...
<thead>
<td colspan="8" style="background-color:#09F;"><strong style="color:#FFF; font-size:22px;"><?php echo"$Purchases_lang"; ?></strong></td>
</thead>
...
if($supplier_id=="" or $supplier_id==null){}else{$add_sql.="supplier='$supplier_id' and ";}
	...
	*/
	$query = "SELECT COUNT(*) as num  FROM  ".$prefix."_receivings_inv  where $add_sql type in('1','2') and  left(date, 10) BETWEEN '$from' AND '$to'";
...
$sql = "SELECT * FROM ".$prefix."_receivings_inv where $add_sql type='1' and left(date,10) BETWEEN '$from' AND '$to' order by $orderby $type LIMIT $start, $limit";	
...
?>
 ...
 <a href="receivings_edit.php?id=<?php echo"".$row['inv_id'].""; ?>" target="_BLANK"><img src="images/edit.png"/></a>
...
$result_get = mysqli_query($con,"SELECT Total,discount FROM ".$prefix."_receivings_inv where type in('1','2') and left(date,10) BETWEEN '".$from."' AND '".$to."'");
