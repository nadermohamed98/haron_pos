...
<div id="receipt_wrapper">
    ...
    <div id="receipt_general_info" style="">
<div id="sale_id"><span dir="rtl"> <?php echo" ".$row_sales_inv['inv_id'].""; ?> </span> <span dir="rtl"> <?php echo" $number_lang"; ?>: </span></div>
<div id="employee"><span dir="rtl"> <?php echo" ".$user_name.""; ?> </span><span dir="rtl"> <?php echo" $the_Employee"; ?>: </span></div>
<div id="doc" class="text-left"><span dir="rtl"> <?php echo" ".$row_sales_inv['doc'].""; ?> </span> <span dir="rtl"><?php echo"DOC#"; ?>:</span></div>
...
while($row_search_suppliers= mysqli_fetch_array($result_search_suppliers))
  {
	  echo'<div dir="rtl" class="text-center"><br /><span dir="rtl">   '.$The_Supplier_lang.'  : </span>   <span dir="rtl">  '.$row_search_suppliers['name'].'  </span></div>';
  }
}
	}
	...
	$it_price=$row_inv['BuyPrice'];
      ...
      echo"</td>
		...
		<tr>
		  ...
		  <td style='text-align:center;border-top:2px solid #000000;'><?php echo $num_qty; ?></td>
		  ...
		  <td style='text-align:center;border-top:2px solid #000000;'></td>
		  <td style='text-align:center;border-top:2px solid #000000;'></td>
                   <td style='text-align:center;border-top:2px solid #000000;'><?php echo $row_sales_inv['discount']; ?><?php if($Discount_type=="2"){echo"%";} ?></td>
                                 <?php  if($use_sizes==1){ echo"<td style='text-align:center;border-top:2px solid #000000;'></td>";} ?>
           <?php  if($use_colors==1){ echo"<td style='text-align:center;border-top:2px solid #000000;'></td>";} ?>
		  <td  style='text-align:center;border-top:2px solid #000000;'>
		  <?php if($Discount_type=="2"){
                      echo $net_disc= ($total*-1)*$row_sales_inv['discount']/100;
                      }else{
                          if($_GET['type']=="sales_returns"){
			  echo $net_disc= $row_sales_inv['discount'];
                          }else{
                              echo $net_disc= $row_sales_inv['discount'];
                          }
			  } ?></td>
            	...
            	<tr>
		  <td style='text-align:right;border-top:2px solid #000000;'><?php echo"$the_total_after_lang"; ?></td>
		  <td style='text-align:right;border-top:2px solid #000000;'>&nbsp;</td>
		  <td style='text-align:center;border-top:2px solid #000000;'></td>
		  <td style='text-align:center;border-top:2px solid #000000;'></td>
                  <td style='text-align:center;border-top:2px solid #000000;'></td>
          ...
          <?php  if($use_colors==1){ echo"<td style='text-align:center;border-top:2px solid #000000;'></td>";} ?>
		  <td  style='text-align:center;border-top:2px solid #000000;'>
                      <?php if($_GET['type']=='sales_returns'){
                          $total_after_disc=($total-$net_disc);}else if($_GET['type']=='sale'){$total_after_disc=($total-$net_disc);}
                      
                      else if($_GET['type']=='receivings'){
                          $total_after_disc=($total-$net_disc);} else{$total_after_disc=($total-$net_disc);} ?>
		  <?php echo"".$total_after_disc." ".$get_db_Currency.""; ?></td>
	    </tr>
                        	<tr>
		  <td style='text-align:right;border-top:2px solid #000000;'><?php echo"ضرائب المبيعات"; ?></td>
		  <td style='text-align:right;border-top:2px solid #000000;'>&nbsp;</td>
		  <td style='text-align:center;border-top:2px solid #000000;'></td>
		  <td style='text-align:center;border-top:2px solid #000000;'></td>
                  <td style='text-align:center;border-top:2px solid #000000;'></td>
          ...
          <?php  if($use_colors==1){ echo"<td style='text-align:center;border-top:2px solid #000000;'></td>";} ?>
		  <td  style='text-align:center;border-top:2px solid #000000;'>
                      <?php if($_GET['type']=='sale'){$add_tax=$row_sales_inv['tax'];}else{$add_tax=($row_sales_inv['tax']*-1);} ?>
		  <?php echo"".$add_tax." ".$get_db_Currency.""; ?></td>
	    </tr>
                                    	<tr>
		  <td style='text-align:right;border-top:2px solid #000000;'><?php echo"Total after Tax"; ?></td>
		  <td style='text-align:right;border-top:2px solid #000000;'>&nbsp;</td>
		  <td style='text-align:center;border-top:2px solid #000000;'></td>
		  <td style='text-align:center;border-top:2px solid #000000;'></td>
                  <td style='text-align:center;border-top:2px solid #000000;'></td>
          ...
          <?php  if($use_colors==1){ echo"<td style='text-align:center;border-top:2px solid #000000;'></td>";} ?>
		  <td  style='text-align:center;border-top:2px solid #000000;'>
                         <?php if($_GET['type']=='sale'){$add_total_after_tax=$total_after_disc+$row_sales_inv['tax'];}
                         else if($_GET['type']=='sales_returns'){$add_total_after_tax=$total_after_disc+$row_sales_inv['tax'];}
                         else{$add_total_after_tax=$total_after_disc;} ?>
		  <?php echo"".$add_total_after_tax." ".$get_db_Currency.""; ?></td>
	    </tr>
                                    	<tr>
		  <td style='text-align:right;border-top:2px solid #000000;'><?php echo"م.النقل"; ?></td>
		  <td style='text-align:right;border-top:2px solid #000000;'>&nbsp;</td>
		  <td style='text-align:center;border-top:2px solid #000000;'></td>
		  <td style='text-align:center;border-top:2px solid #000000;'></td>
                  <td style='text-align:center;border-top:2px solid #000000;'></td>
          ...
          <?php  if($use_colors==1){ echo"<td style='text-align:center;border-top:2px solid #000000;'></td>";} ?>
		  <td  style='text-align:center;border-top:2px solid #000000;'>
                      <?php if($_GET['type']=='sale'){$add_shipping=$row_sales_inv['shipping'];}else{$add_shipping=($row_sales_inv['shipping']*-1);} ?>
		  <?php echo"".$add_shipping." ".$get_db_Currency.""; ?></td>
	    </tr>
                                    	<tr>
		  <td style='text-align:right;border-top:2px solid #000000;'><?php echo"الاجمالى بعد النقل"; ?></td>
		  <td style='text-align:right;border-top:2px solid #000000;'>&nbsp;</td>
		  <td style='text-align:center;border-top:2px solid #000000;'></td>
		  <td style='text-align:center;border-top:2px solid #000000;'></td>
                  <td style='text-align:center;border-top:2px solid #000000;'></td>
          ...
          <?php  if($use_colors==1){ echo"<td style='text-align:center;border-top:2px solid #000000;'></td>";} ?>
		  <td  style='text-align:center;border-top:2px solid #000000;'>
                         <?php if($_GET['type']=='sale'){$add_total_after_shipping=$add_total_after_tax+$row_sales_inv['shipping'];}else if($_GET['type']=='sales_returns'){$add_total_after_shipping=$add_total_after_tax;}else{$add_total_after_shipping=$total_after_disc;} ?>
		  <?php echo"".$add_total_after_shipping." ".$get_db_Currency.""; ?></td>
	    </tr>
		<tr>
        ...
        <tr>
		  ...
		  /*if($row_sales_inv['type']==1){
		   echo"".($Totalnext-$total-$row_sales_inv['paid'])." ".$get_db_Currency."";
			  ...
			  if($_GET['type']=="sales_returns"){
				//   echo ($total)-($net_disc)+$row_sales_inv['paid'];
                                    echo round($row_sales_inv['paid'],3)+round($add_total_after_tax,3);
				  }else if($_GET['type']=="sale"){
				   echo ($add_total_after_tax)-$row_sales_inv['paid'];
                                          }else if($_GET['type']=="receivings_returns"){}else{

                                             echo ($total+$row_sales_inv['tax'])-($net_disc)-$row_sales_inv['paid'];
                                          }
			 
			//  print ($total-$net_disc)+$row_sales_inv['paid'];
		    ?></span></td>
	    </tr>
		<tr>
