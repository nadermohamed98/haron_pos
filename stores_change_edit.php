...
//
                                    ...
                                    while ($row_up = mysqli_fetch_array($result_up)) {
                                        ...
                                        $updateSqlStatement="UPDATE " . $prefix . "_stores_change SET staff='" . $staff . "',Quantity='" . $quantity . "',
Price='" . $Price . "',Discount='" . $Discount . "',Total='" . $Total . "',date='" . $DueDate . "',type='1',stores_change_type='" . $stores_change_type . "',BuyPrice=(select price from items where id='" . $item . "') where user_id='$user_id' and id='" . $row_up['id'] . "'";
