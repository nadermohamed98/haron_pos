	...
	$.fn.contextMenu = function(menu,options) {
		...
		return this.each(function(){
			$(this).bind('contextmenu',function(e){cmenu.show(this,e);return false;});
																...
																var menu1 = [
																{
									'مرتجعات المشتريات' : function(menuItem, menu) {
										window.location.assign("receivings_returns.php")
									}
								}
								, $.contextMenu.separator, {
									'مرتجعات المبيعات' : function(menuItem, menu) {
										window.location.assign("sales_returns.php")
									}
								}
								, $.contextMenu.separator, {
									'المجموعات' : function(menuItem, menu) {
										window.location.assign("groups.php")
									}
								}
																, $.contextMenu.separator, {
									'تقرير مشتريات صنف' : function(menuItem, menu) {
										window.location.assign("reports.php?reports=item_receivings")
									}
								}
								
																								, $.contextMenu.separator, {
									'تقرير المصروفات' : function(menuItem, menu) {
										window.location.assign("reports.php?reports=expenses")
									}
								}
								
																						, $.contextMenu.separator, {
									'الاصناف الاكثر مبيعاً' : function(menuItem, menu) {
										window.location.assign("reports.php?reports=items_and_inventory")
									}
								}
								
										, $.contextMenu.separator, {
									'متابعة أوامر التوريد ' : function(menuItem, menu) {
										window.location.assign("reports.php?reports=order_supply")
									}
								}
								
																		, $.contextMenu.separator, {
									'تقرير المشتريات' : function(menuItem, menu) {
										window.location.assign("reports.php?reports=receivings")
									}
								}
								
																										, $.contextMenu.separator, {
									'تقرير المبيعات' : function(menuItem, menu) {
										window.location.assign("reports.php?reports=sales")
									}
								}
								
								, $.contextMenu.separator, {
									'تقرير اليومية' : function(menuItem, menu) {
										window.location.assign("daily.php")
									}
								}
                                                                	, $.contextMenu.separator, {
										'حالات امر التوريد' : function(menuItem, menu) {
										window.location.assign("order_supply_status.php")
									}
								}
								/*	
								
																, $.contextMenu.separator, {
									'خدمات فورى' : function(menuItem, menu) {
										window.location.assign("fawry.php")
									}
								}
								
																, $.contextMenu.separator, {
									'مدفوعات فورى' : function(menuItem, menu) {
										window.location.assign("fawry_pay.php")
									}
								}
							, $.contextMenu.separator, {
									'أخضر' : function(menuItem, menu) {
										alert("<form></form>");
									}
								}*/
...
/*								var menu1 = [{
									'أحمر' : function(menuItem, menu) {
										window.location.assign("receivings.php?color=111111")
									}
								}, $.contextMenu.separator, {
									'أخضر' : function(menuItem, menu) {
