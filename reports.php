                        ...
                        <form method="get" id="contentnoprint">
                            ...
                            <div style="width:100%; margin:0 auto;">
                                ...
                                if ($_GET['reports'] == "client_returns" or $_GET['reports'] == "customer_payments") {
                                    ...
                                    ?>
                                    <div style="width:20%; float:right;"><label
                                                style="float:right; "><?php echo "$The_client_lang"; ?></label><input
                                                type="text" name="client" id="client" dir="rtl"
                                                value="<?php if (isset($_GET['clientID'])) {
                                                    echo "" . $clientname . "";
                                                } ?>"
                                                class="w100 form-control" <?php if ($_GET['reports'] == "customer_payments") { ?> onkeyup="showResultsOfClipaym(this.value);" <?php } else { ?> onkeyup="showResultsOfCli(this.value);"<?php } ?>
                                                autocomplete="off"/>
                                        <div id="livesearchcli"
                                             style="z-index:1000000000; width:20%; padding-right:50px;  text-align:right; margin-top:5px;  float:right; position:fixed; border:0px; "></div>
                                ...
                                if ($_GET['reports'] == "suppliers_receivings" or $_GET['reports'] == "payments_suppliers") {
                                    ...
                                    ?>
                                    <div style="width:20%; float:right;"><label
                                                style="float:right; "><?php echo "$The_Supplier_lang"; ?></label><input
                                                type="text" name="supplier" id="supplier" dir="rtl"
                                                value="<?php if (isset($_GET['SupplierID'])) {
                                                    echo "" . $suppliername . "";
                                                } ?>" class="w100 form-control"
                                                <?php if ($_GET['reports'] == "payments_suppliers") { ?>onkeyup="showResultspaym(this.value)"
                                                <?php } else { ?>onkeyup="showResults(this.value)" <?php } ?>
                                                autocomplete="off"/>
                                        <div id="livesearchcl"
                                             style="z-index:1000000000; width:20%; padding-right:50px;  text-align:right; margin-top:5px;  float:right; position:fixed; border:0px; "></div>
                                ...
                                if ($_GET['reports'] == "item_order_supply" or $_GET['reports'] == "item_sale") {
                                    ...
                                    ?>
                                    <div style="width:20%; float:right;"><label
                                                style="float:right; "><?php echo "$the_Item_lang"; ?></label><input
                                                type="text" name="item" id="item" value="<?php if (isset($_GET['q'])) {
                                            echo "" . $itemsname . "";
                                ...
                                <div style="width:15%; float:right;"><label
                                            style="float:right; "><?php echo "$from_lang"; ?></label><input type="text"
                                                                                                            name="from"
                                                                                                            id="from"
                            ...
                            <?php if ($_GET['reports'] == "receivings" or $_GET['reports'] == "sales") { ?>
                                <!--                                    <div style="width:10%; float:right;"><label style="float:right; ">--><?php //echo"INV#"; ?><!--</label>-->
...
//                                        } ?><!--" class="w100 form-control"   autocomplete="off" />-->
                            ...
                            <?php } ?>
                            <?php if ($_GET['reports'] == "sales") { ?>
                                <div style="width:10%; float:right;"><label
                                            style="float:right; "><?php echo "DOC#"; ?></label><input type="text"
                                                                                                      name="doc"
                                                                                                      id="doc" dir="rtl"
                            ...
                            <?php if ($_GET['reports'] == "detailed_order_supply" or $_GET['reports'] == "detailed_sales") { ?>
                                <div style="width:10%; float:right;"><label
                                            style="float:right; "><?php echo "المجموعة"; ?></label>
                            ...
                            <?php if ($_GET['reports'] == "detailed_order_supply" or $_GET['reports'] == "detailed_sales") { ?>
                                <div style="width:10%; float:right;"><label
                                            style="float:right; "><?php echo "الشركة"; ?></label>
                            ...
                            <?php if ($_GET['reports'] == "order_supply") { ?>
                                <?php if ($user_excel_order_supply !== "1" and $user_IsAdmin != 1) {
                                    ...
                                    <div style=" float:right; padding-top:20px; text-align:center;">
                                        <a href="#" id="excel" class="btn btn-danger"> <i
                                                    class="fa fa-file-excel-o"> <?php echo "$export_report_lang"; ?></i></a>
                                    </div>
                                <?php } ?>
                                <?php if ($user_pdf_order_supply !== "1" and $user_IsAdmin != 1) {
                                } else { ?>
                                    <div style=" float:right; padding-top:20px; text-align:center;">
                                        <a href="#" id="allmultiPrint" class="btn btn-primary"><i
                                                    class="fa fa-print"></i><?php echo $print_all_lang; ?></a>
                                    </div>
                                <?php } ?>
                            ...
                            <?php if ($_GET['reports'] == "receivings") {
                                ...
                                <div style=" float:right; padding-top:20px; text-align:center;">
                                    <?php if ($user_pdf_order_supply !== "1" and $user_IsAdmin != 1) {
                                        ...
                                        <a href="#" id="allmultiPrintreceivings"><i
                                                    class="fa fa-print"></i><?php echo $print_all_lang; ?></a>
                            ...
                            <?php if ($_GET['reports'] == "treasury_statement") { ?>
                                ...
                                <div style=" float:right; padding-top:20px; text-align:center;">
                                    <?php if ($user_user_treasury !== "1" and $user_IsAdmin != 1) {
                                        ...
                                        <a href="#" id="allmultiPrintTreauryStatement"><i
                                                    class="fa fa-print"></i><?php echo $print_lang; ?></a>
                    ...
                    <div class="fright" id="contentnoprint3">
                        ...
                        <div id='cssmenu'>
                            ...
                            <ul>
                                ...
                                <li><a target="_BLANK"
                                       href="regions_orders_rate_r.php"><span>اﻻوردرات المجمعه - الفروع</span></a></li>
                                <li><a target="_BLANK"
                                       href="orders_rate_emps_r.php"><span>اوردرات الموظفين المجمع</span></a></li>
                                ...
                                <?php if ($user_ReportsPurchases !== "1" and $user_IsAdmin != 1) {
                                    ...
                                    <li class='<?php if ($_GET['reports'] == "receivings" or $_GET['reports'] == "receivings_returns" or $_GET['reports'] == "suppliers_receivings" or $_GET['reports'] == "item_receivings") {
                                        ...
                                        <ul>
                                            ...
                                            <li class='last'><a
                                                        href='?reports=suppliers_receivings'><span><?php echo "$Purchases_supplier_lang"; ?></span></a>
                                            </li>
                                            <li class='last'><a
                                                        href='?reports=item_receivings'><span><?php echo "$Purchases_items_lang"; ?></span></a>
                                            </li>
                                        </ul>
                                    </li>
                                <?php } ?>
                                ...
                                <?php if ($user_SalesReports !== "1" and $user_IsAdmin != 1) {
                                    ...
                                    <li class='<?php if ($_GET['reports'] == "sales" or $_GET['reports'] == "sales_returns" or $_GET['reports'] == "client_returns" or $_GET['reports'] == "items_returns") {
                                        ...
                                        <ul>
                                            ...
                                            <li class='last'><a
                                                        href='?reports=client_returns'><span><?php echo "$Returns_client_lang"; ?></span></a>
                                            </li>
                                            <li class='last'><a
                                                        href='?reports=items_returns'><span><?php echo "$Return_items_lang"; ?></span></a>
                                            </li>
                                        </ul>
                                    </li>
                                <?php } ?>
