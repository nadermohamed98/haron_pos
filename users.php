...
<input type="text" name="username"   class="form-control" value="<?php echo"$row_username"; ?>" /></th>
    <td colspan="2" class="text-right"><span style="vertical-align:middle;"><?php echo"$password_lang"; ?></span>     
      ...
      <td colspan="2" class="text-right"><span style="vertical-align:middle;"><?php echo"$the_branch_name_lang"; ?></span>
...
<hr style="color:#E8E8E8;" />
  ...
  <tr>
    ...
    <th class="text-right"><input  class="form-control" type="checkbox" value="1" name="user_treasury" id="user_treasury" <?php if($row_user_treasury=="1"){echo"checked";} ?>  /></th>
      ...
      <th class="text-right"><input  class="form-control" type="checkbox" value="1" name="user_stores_change" id="user_stores_cange" <?php if($row_user_stores_change=="1"){echo"checked";} ?>  /></th>
    ...
    <tr>
        ...
        <th class="text-right"><input  class="form-control" type="checkbox" value="1" name="user_edit_stores_change" id="user_stores_cange" <?php if($row_user_edit_stores_change=="1"){echo"checked";} ?>  /></th>

        <th class="text-right"><label for="user_order_supply"><?php echo"$order_supply_lang"; ?></label></th>
        <th class="text-right"><input  class="form-control" type="checkbox" value="1" name="user_order_supply" id="user_order_supply" <?php if($row_user_order_supply=="1"){echo"checked";} ?>  /></th>

        <th class="text-right"><label for="user_edit_order_supply"><?php echo"$edit_order_supply_lang"; ?></label></th>
        <th class="text-right"><input  class="form-control" type="checkbox" value="1" name="user_edit_order_supply" id="user_edit_order_supply" <?php if($row_user_edit_order_supply=="1"){echo"checked";} ?>  /></th>

        <th class="text-right"><label for="user_delete_order_supply"><?php echo"$delete_order_supply_lang"; ?></label></th>
        <th class="text-right"><input  class="form-control" type="checkbox" value="1" name="user_delete_order_supply" id="user_delete_order_supply" <?php if($row_user_delete_order_supply=="1"){echo"checked";} ?>  /></th>


     </tr>
    <tr>
        <th class="text-right"><label for="user_order_supply_report"><?php echo"$order_supply_report_lang"; ?></label></th>
        <th class="text-right"><input  class="form-control" type="checkbox" value="1" name="user_order_supply_report" id="user_order_supply_report" <?php if($row_user_order_supply_report=="1"){echo"checked";} ?>  /></th>

        <th class="text-right"><label for="user_pdf_order_supply"><?php echo"$pdf_order_supply_lang"; ?></label></th>
        <th class="text-right"><input  class="form-control" type="checkbox" value="1" name="user_pdf_order_supply" id="user_pdf_order_supply" <?php if($row_user_pdf_order_supply=="1"){echo"checked";} ?>  /></th>
        <th class="text-right"><label for="user_excel_order_supply"><?php echo"$excel_order_supply_lang"; ?></label></th>
        <th class="text-right"><input  class="form-control" type="checkbox" value="1" name="user_excel_order_supply" id="user_excel_order_supply" <?php if($row_user_excel_order_supply=="1"){echo"checked";} ?>  /></th>

        <th class="text-right"><label for="user_offers"><?php echo"$edit_offers_lang"; ?></label></th>
        <th class="text-right"><input  class="form-control" type="checkbox" value="1" name="user_offers" id="user_offers" <?php if($row_user_offers=="1"){echo"checked";} ?>  /></th>
  ...
  <tr>
      ...
      <th class="text-right"><input  class="form-control" type="checkbox" value="1" name="user_edit_offers" id="user_edit_offers" <?php if($row_user_edit_offers=="1"){echo"checked";} ?>  /></th>

      <th class="text-right"><label for="DeleteSalesInv"><?php echo"$DeleteSalesInv_lang"; ?></label></th>
      <th class="text-right"><input  class="form-control" type="checkbox" value="1" name="DeleteSalesInv" id="DeleteSalesInv" <?php if($row_DeleteSalesInv=="1"){echo"checked";} ?>  /></th>

      <th class="text-right"><label for="DeleteStoresChange"><?php echo"$DeleteStoresChange_lang"; ?></label></th>
      <th class="text-right"><input  class="form-control" type="checkbox" value="1" name="DeleteStoresChange" id="DeleteStoresChange" <?php if($row_DeleteStoresChange=="1"){echo"checked";} ?>  /></th>
